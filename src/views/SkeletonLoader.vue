    ...
    >
      <div v-if="isLoadingRendered">
        <section class="flex flex-col gap-4 w-full">
          <div class="sm:w-48 w-32 h-6 mb-6 skeleton-title-bar-i"></div>
          <div class="sm:w-96 w-24 h-3 skeleton-text-bar-i"></div>
          <div class="sm:w-32 w-32 h-3 skeleton-text-bar-i"></div>
          <div class="sm:w-64 w-8 h-3 skeleton-text-bar-ii" ></div>
          <div class="sm:w-64 w-20 h-3 skeleton-text-bar-i" ></div>
        </section>
